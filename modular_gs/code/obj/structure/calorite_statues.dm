...
/obj/structure/statue/calorite/fatty/proc/statue_fatten(mob/living/carbon/M, touch = TRUE)
	...
	else if(M.fatness < FATNESS_LEVEL_16)
	...
	else if(M.fatness < FATNESS_LEVEL_18)
